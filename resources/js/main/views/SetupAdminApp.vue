                ...
                <a-steps :current="currentStep">
                    <a-step :status="warehouseStepStatus">
                        ...
                        <template #description>
                            <span>{{
                                $t("setup_company.add_first_warehouse")
                            }}</span>
                        </template>
                    </a-step>
                    ...
                    <a-step :status="paymentModeStepStatus">
                        ...
                        <template #description>
                            <span>{{
                                $t("setup_company.add_payment_mode")
                            }}</span>
                        </template>
                    </a-step>
...
export default defineComponent({
    ...
    setup() {
        ...
        const checkStepNumber = () => {
            axiosAdmin.get("app").then((appResponse) => {
                ...
                stepStatus.paymentModeStepStatus =
                    appDetails.value.total_payment_modes > 0
                        ? "finish"
                        : "wait";
        ...
        const goBack = () => {
            currentStep.value =
                currentStep.value == 0 ? 0 : currentStep.value - 1;
        };

        const goNext = () => {
            currentStep.value =
                currentStep.value >= 3 ? 3 : currentStep.value + 1;
        };
